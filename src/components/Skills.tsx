    ...
    <div id='skills' className='container pt-32'>
      <div className='grid md:grid-cols-2 gap-20 items-center'>
        <div data-aos="zoom-in-up">
          ...
          to using frameworks like REact and Next.js to create dynamic and user-friendly applications. I am also proficinet
          in Tailwind CSS for efficient styling and design. with a passion for learning. I stay updated on the latest 
          technologies to enhance my skill set and contribute to projects.
          </p>
